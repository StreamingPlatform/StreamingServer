...
export async function getEmbedSu(tmdb_id, season = null, episode = null) {
  ...
  try {
    // Use the correct URL format for movies or TV shows
    ...
    if (!secondDecode || secondDecode.length === 0) return { provider: "EmbedSu", sources: [], subtitles: [] };
